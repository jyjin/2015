define(function(require) {
	...
	*/
	...
	//edit by jyjin , remove var to set the variable to gloal variable
	...
	SWFUpload.completeURL = function(a) {
		...
		if (b <= 0) {
			...
			temppath = window.location.pathname.substr(0, b) + "/"; //fixed ie8 image doesnt show
		}
		if (temppath) return temppath + a;
		return path + a
	};
